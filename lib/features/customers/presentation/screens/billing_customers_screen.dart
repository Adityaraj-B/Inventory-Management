...
class BillingCustomersScreen extends StatefulWidget {
  const BillingCustomersScreen({super.key});

  @override
  State<BillingCustomersScreen> createState() => _BillingCustomersScreenState();
}

class _BillingCustomersScreenState extends State<BillingCustomersScreen> {
  Timer? _debounce;
  ...
  void initState() {
    ...
    context.read<CustomerListBloc>().add(
      CustomerListLoadRequested(warehouseId: warehouseId),
    );
  }
  ...
  void _onSearchChanged(String query) {
    ...
    _debounce = Timer(const Duration(milliseconds: 300), () {
      context.read<CustomerListBloc>().add(
        CustomerSearchChanged(query, warehouseId: warehouseId),
      );
    });
  }
  ...
  void _showAddCustomerDialog(String? warehouseId) {
          ...
          child: FloatingActionButton.extended(
            ...
            onPressed: () {
              ...
              final user = authState is AuthAuthenticated
                  ? authState.user
                  : null;
              final warehouseId = user?.warehouseId ?? 'wh-1';
              _showAddCustomerDialog(warehouseId);
            },
            icon: const Icon(
            ...
            Padding(
              ...
              child: Container(
                ...
                child: SearchBarWidget(
                  hintText: 'Search customer name, phone or city...',
                    ...
                    if (state.customers.isEmpty) {
                      return EmptyState(
                        title: state.searchQuery.isEmpty
                            ? 'No customers in warehouse'
                            : 'No matching customers',
                        message: state.searchQuery.isEmpty
                            ? 'No registered customers for your assigned warehouse.'
